    ...
    public class BoletoRepository : IBoletoRepository
    {
        ...
        private static Boleto GerarLayoutBoleto(IBanco banco, DadosBoleto dadosBoleto, Sacado sacado, DadosEndereco endereco)
        {
            var boleto = new Boleto(banco)
            {
                ...
                MensagemArquivoRemessa = "tesde de menssagem ao banco meu remessa",
                ComplementoInstrucao1 = "teste de menssagem ao banco complemento",
                MensagemInstrucoesCaixa = "tesde de menssagem ao banco",
